...
function Testimonials() {
  return (
    <>
      <section className="h-auto py-10 px-4 md:px-[120px]">
        <div className="text-center flex flex-col space-y-5">
          <h1 className="text-2xl md:text-4xl font-semibold">What they have to say</h1>
        ...
        <div className="md:grid md:grid-cols-2 md:gap-20 mt-16 md:h-[557px] md:mx-20">
          <div className="bg-[#FBF8FB] rounded-[16px] p-[32px]">
            <div className="flex md:space-x-12">
              ...
              <div className="flex flex-col justify-center">
                <h2 className="font-semibold text-2xl md:text-[24px]">Dr Rekha</h2>
                <p className="text-sm md:text-[14px] font-normal">
            ...
            <div className="space-y-8 font-normal text-sm md:text-[16px] mt-8">
              <p>
          ...
          <div className="bg-[#FBF8FB] rounded-[16px] p-[32px]">
            <div className="flex space-x-12">
              ...
              <div className="flex flex-col md:justify-center justify-between">
                <h2 className="font-semibold text-2xl md:text-[24px]">Dr Girija Ganesan</h2>
                <p className="text-sm md:text-[14px] font-normal">
      ...
      <div className="bg-secondary md:h-[245px] h-[280px] text-white md:mt-[100px]">
