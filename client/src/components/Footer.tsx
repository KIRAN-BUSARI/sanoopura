            ...
            <div className="flex justify-between items-center h-full">
                ...
                <div className="flex flex-col space-y-8">
                    <div className="space-y-1">
                        ...
                        <p className="text-[16px] font-normal">No 341 Sai Sparsh 2nd Floor, 8th Main Rd, JHCS Layout,<br />
                            Uttarahalli Hobli, Bengaluru, Karnataka 560061.</p>
                    </div>

                    <h3 className="text-[24px] font-semibold">Contact: + 91-9611494919</h3>
                </div>
            </div>
        </div>
    );
